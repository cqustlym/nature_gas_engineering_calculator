...
// ============ 单个计算处理 ============
pub async fn calculate_z_handler(Json(req): Json<CalculateZReq>) -> Result<Json<Vec<f64>>, StatusCode> {
    let z_values: Vec<f64> = req.pressures
        .par_iter()
...
pub async fn calculate_bg_handler(Json(req): Json<CalculateBgReq>) -> Result<Json<Vec<f64>>, StatusCode> {
    let bg_values: Vec<f64> = req.pressures
        .par_iter()
...
pub async fn calculate_cg_handler(Json(req): Json<CalculateCgReq>) -> Result<Json<Vec<f64>>, StatusCode> {
    let cg_values: Vec<f64> = req.pressures
        .par_iter()
...
pub async fn calculate_density_handler(Json(req): Json<CalculateDensityReq>) -> Result<Json<Vec<f64>>, StatusCode> {
    let density_values: Vec<f64> = req.pressures
        .par_iter()
...
pub async fn calculate_niandu_handler(Json(req): Json<CalculateNianduReq>) -> Result<Json<Vec<f64>>, StatusCode> {
    let niandu_values: Vec<f64> = req.pressures
        .par_iter()
...
pub async fn calculate_pwbs_handler(Json(req): Json<CalculatePwbsReq>) -> Result<impl IntoResponse, StatusCode> {
