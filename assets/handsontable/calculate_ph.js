...
const CONTENT_HEADERS = ['井底压力(MPa)', '井口压力(MPa)', 'Z', 'P/Z', '1/Bg', 'μ', 'Cg'];
    ...
    fetch('/api/calculateBatchPh', {
        ...
        .then(results => {
            const newData = pressuresRaw.map((orig, idx) => {
                ...
                return [parseFloat(orig), r.ph, r.z, r.p_over_z, invBg, r.niandu, r.cg];
            });
